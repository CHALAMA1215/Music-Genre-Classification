...
for test_size in test_sizes:
    print(f"\n{'='*20} Decision Tree | Split: {int((1-test_size)*100)}% Train / {int(test_size*100)}% Test {'='*20}")
    ...
    plt.title(f'Decision Tree Confusion Matrix ({int((1-test_size)*100)}/{int(test_size*100)} Split)')
