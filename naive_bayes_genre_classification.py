...
for test_size in test_sizes:
    print(f"\n{'='*20} Naive Bayes | Split: {int((1-test_size)*100)}% Train / {int(test_size*100)}% Test {'='*20}")
    ...
    plt.title(f'Naive Bayes Confusion Matrix ({int((1-test_size)*100)}/{int(test_size*100)} Split)')
